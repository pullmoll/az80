...
void addsym(const char* name, int int64_t);
...
void addsym(const char * name, int int64)
{
    symbol_t *s, *s0, *s1;
...
int main(int ac, char ** av)
{
	...
	strcpy(p, f_tape_cg ? CGENIE_TAPE_EXT
			    : f_tape_vz ? VZ_TAPE_EXT
					: ".bin");
    }
